...
export function loadingMap(type, key) {
    return new Promise(function(resolve, reject) {
      ...
      let amapLoad = () => {
        ...
        script.src = "https://webapi.amap.com/maps?v=1.4.5&key=4746a37c6890d066a3194cec26fcb1fd" + key + "&plugin=AMap.Autocomplete,AMap.PlaceSearch,AMap.Geocoder,AMap.MapType,AMap.Driving,AMap.DistrictSearch";
      ...
      let bmapLoad = () => {
        ...
        s.src = 'https://api.map.baidu.com/getscript?v=2.0&ak=pp80VAShAECfOms9SkWCHqvCXazME1tE' + key + '&services=&t=20180629105709&s=1';
